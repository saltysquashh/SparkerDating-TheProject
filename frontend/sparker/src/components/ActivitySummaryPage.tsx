...
const ActivitySummaryPage = () => {
    ...
    const [activitySummary, setActivitySummary] = useState<UserActivitySummaryDTO | null>(null);
        ...
        <div className="welcome-page-container">
            ...
            <div className="welcome-section">
                ...
                {expiredMatches.length > 0 ? (
                    ...
                    <p>No matches expired while you were gone, but make sure to check up on them before it's too late!</p>
                )}
            </div>
        </div>
        </div>
