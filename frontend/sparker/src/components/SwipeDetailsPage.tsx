    ...
    return (
        ...
        <div className="swipe-card-container">
            <div className="swipe-header">
                ...
                <div className="swipe-detail-text">Age: {swipeUserInfo?.age}</div>
                <div className="swipe-detail-text">Gender: {swipeUserInfo?.gender}</div>
                </div> 
            </div>
                ...
                <div className="swipe-status-section">
                    ...
                    {!isMatched ? (
                            <h1>You have not matched with {swipeUserInfo.firstName} yet</h1>
                        ) : (
            ...
            <div className="swipe-actions">
                        {!isMatched ? (
                            ...
                            <Button onClick={handleGoToMatchClick} colorScheme='blue' className="action-button">Go to Match</Button>
                        )}
                    </div>
            </div>
            </div>
